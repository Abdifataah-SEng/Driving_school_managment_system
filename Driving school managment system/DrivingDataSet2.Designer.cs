...
namespace Driving_school_managment_system {
    ...
    public partial class DrivingDataSet2 : global::System.Data.DataSet {
        ...
        public partial class InstructorsDataTable : global::System.Data.TypedTableBase<InstructorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public InstructorsRow AddInstructorsRow(int Id, string Name, string Email, int Phone, string Address, string Status, System.DateTime JoinDate) {
        ...
        public partial class InstructorsRow : global::System.Data.DataRow {
            ...
            public int Phone {
                get {
                    return ((int)(this[this.tableInstructors.PhoneColumn]));
                }
                set {
            ...
            public System.DateTime JoinDate {
                get {
                    return ((global::System.DateTime)(this[this.tableInstructors.JoinDateColumn]));
                }
                set {
                    this[this.tableInstructors.JoinDateColumn] = value;
                }
            }
        }
...
namespace Driving_school_managment_system.DrivingDataSet2TableAdapters {
    ...
    public partial class InstructorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Instructors] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([Status] = @Original_Status) AND ([JoinDate] = @Original_JoinDate))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Instructors] ([Id], [Name], [Email], [Phone], [Address], [Status], [JoinDate]) VALUES (@Id, @Name, @Email, @Phone, @Address, @Status, @JoinDate);
SELECT Id, Name, Email, Phone, Address, Status, JoinDate FROM Instructors WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Instructors] SET [Id] = @Id, [Name] = @Name, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [Status] = @Status, [JoinDate] = @JoinDate WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([Status] = @Original_Status) AND ([JoinDate] = @Original_JoinDate));
SELECT Id, Name, Email, Phone, Address, Status, JoinDate FROM Instructors WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Email, Phone, Address, Status, JoinDate FROM dbo.Instructors";
        ...
        public virtual int Fill(DrivingDataSet2.InstructorsDataTable dataTable) {
        ...
        public virtual DrivingDataSet2.InstructorsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DrivingDataSet2.InstructorsDataTable dataTable = new DrivingDataSet2.InstructorsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DrivingDataSet2.InstructorsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, string Original_Status, System.DateTime Original_JoinDate) {
        ...
        public virtual int Insert(int Id, string Name, string Email, int Phone, string Address, string Status, System.DateTime JoinDate) {
        ...
        public virtual int Update(int Id, string Name, string Email, int Phone, string Address, string Status, System.DateTime JoinDate, int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, string Original_Status, System.DateTime Original_JoinDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, int Phone, string Address, string Status, System.DateTime JoinDate, int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, string Original_Status, System.DateTime Original_JoinDate) {
            return this.Update(Original_Id, Name, Email, Phone, Address, Status, JoinDate, Original_Id, Original_Name, Original_Email, Original_Phone, Original_Address, Original_Status, Original_JoinDate);
        }
    }
        ...
        public virtual int UpdateAll(DrivingDataSet2 dataSet) {
            ...
            try {
                ...
                if ((this._instructorsTableAdapter != null)) {
                    ...
                    this._instructorsTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(workConnection));
                    this._instructorsTableAdapter.Transaction = ((global::Microsoft.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._instructorsTableAdapter != null)) {
                    this._instructorsTableAdapter.Connection = ((global::Microsoft.Data.SqlClient.SqlConnection)(revertConnections[this._instructorsTableAdapter]));
